...
const int APP_H = SCREAN_H - 30;
const int APP_W = SCREAN_W - 30;
/*ID table via screan*/
typedef void (*func)();

void (*R[SCREAN_H][SCREAN_W])(void);
...
struct Button
{
	...
	std::string tile;
	/*contructor*/
	void setButton(int l, int t, int r, int b, int c)
	{
		this->left = l;
		this->top = t;
		this->right = r;
...
typedef struct
{
	...
	int color;
	/*contructor*/
	void setFrame(int l, int t, int r, int b, int c)
	{
		this->left = l;
		this->top = t;
		this->right = r;
...
//	
//	/*set backup ID array*/	
//	unsigned int B_R[201][401];
//	unsigned short int B_IMAGE[201][401];
//	
//	void set_active(){
//
//		int y;
...
//	
//		if( R[y][x]==-ID ) return true; else return false;
//	}
//}
//Dialog;
